$glob = @{
   ...
   OKPD2_Remove = @(
      #"10.", #Ïðîäóêòû ïèùåâûå
      "80.10.12", #Óñëóãè îõðàíû
      "86",  #Óñëóãè â îáëàñòè çäðàâîîõðàíåíèÿ
      "")
   minPrice = 80000
}
...
<#
TODO
ñîõðàíèòü èñõîäíûé xml
ñäåëàòü îòêðûòèå ïàïî÷êè + èôðåéì ñ ïðîñìîòðîì
øò-êã-åä
èíôà äëÿ ïîäà÷è çàÿâêè
îêäï2 ôèëüòð âñå íåïîäõîäÿò, à íå îäíà
ðàçäåëèòåëü ìåæäó çàÿâêàìè
ñîðòèðîâêà ïî îòêðûòèþ
ôèëüòð íà äàòó ñîçäàíèÿ
ññûëêè îòêðûòü â íîâîé âêëàäêå
îáðåçàòü àòòà÷è
#>
